...
// Keys is used to hold the string needed for passing Intents around activities.
public class Keys {
    public static String SP_FILE_NAME           = "LoginPreferences";
    public static String SP_EMAIL_KEY           = "SP_EMAIL_KEY";
    public static String SP_USERTYPE_KEY        = "SP_USERTYPE_KEY";
